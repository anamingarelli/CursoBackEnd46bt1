...
// ==========================================
// 4. Converter o nome Completo para iniciais UpperCase

function gerarIniciais(string $nomeCompleto): string {
    // Escreva a sua lógica aqui!
    // Imagine que eu escrevi um nome completo por 3 partes (Ana Clara Mingarelli) => ACM
    $palavras = explode(" ", $nomeCompleto); // => [Ana, Clara, Mingarelli]
    // precorrer o vetor e pegar cada inicial das  palavras
    $iniciais = "";
