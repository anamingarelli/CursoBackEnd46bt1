...
Adicionando as informações relativas a infraestrutura do banco de dados.

E adicionamos o caminho do arquivo ao `.gitignore` (arquivo não é versionado e não tem perigo de vazar informações confidenciais para internet).
...
Gerenciar o fluxo de inicialização, teste de latência de banco, leitura das informações do banco e tratar falhas e auditar em um arquivo de log
