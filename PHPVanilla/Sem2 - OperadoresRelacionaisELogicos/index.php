...
$valodaParcela = $valorTotalPagar / $numeroParcelas;

//3. O Cérebro da Operação: Avaliação das Regras (Substitua ??? pelo operadores lógicos e relacionais)
...
$rendaSuficiente = $valodaParcela <= $limiteRenda;

//Regra 3: Cliete VIP (Score > 800)
$isClienteVip = $scoreCredito > 800;

//Decisão Final (A Regra Final)
